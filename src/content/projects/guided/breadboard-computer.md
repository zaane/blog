...
whatILearned: |-
  - How the basic logic gates (AND, OR, XOR, NOT, etc.) can be put together into fundamental combinational/sequential logic circuits like adders, decoders, registers, and counters.
  - How these fundamental circuits can combine into larger modules like ALUs and RAM, which can be synchronized with a common clock and transfer data between each other over a common bus. 
...
otherNotes: |-
  ...
  I can confidently promise that once I find gainful employment, this will be one of the first things I get for myself and I look forward to updating this note once I've built the projects for real.
image: ../../../images/beneater.jpg
imageAlt: Breadboard computer thumbnail
externalUrl: https://www.youtube.com/@BenEater/playlists
---
